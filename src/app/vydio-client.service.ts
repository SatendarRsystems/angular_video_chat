...
export class VydioClientService {
    ...
    initVydioConnector(VC, viewId, remoteViewId) {
        ...
        VC.CreateVidyoConnector({
            ...
            this.getTokenData(this.userName).subscribe(response => {
                console.log(response)
                this.joinRoom(response['accessToken'], this.userName, this.meetingRoom);
            });
...
*/
    ...
    getTokenData(userName) {
        return this.http.get("http://vod-demoserver.india.rsystems.com:7000/getAccessToken?username=" + userName);
    }
